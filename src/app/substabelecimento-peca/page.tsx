    ...
    try {
      ...
      if (res.success) {
        ...
        setExtractedData({
          ...
          estadoCivilSubstabelecente: advLeaving.estado_civil || advLeaving.estadoCivil || '',
          ...
          estadoCivilSubstabelecido: advEntering.estado_civil || advEntering.estadoCivil || '',
...
{step === 2 && extractedData && (
            <div className="space-y-8 animate-in fade-in duration-500 max-w-5xl mx-auto pb-20">
              <div className="flex items-center justify-between border-b-2 border-black pb-4">
                ...
                <Button metal={false} variant="ghost" onClick={() => setStep(1)} className="font-black uppercase text-[10px] border-2 border-black rounded-none h-10 px-4">Voltar</Button>
              </div>
